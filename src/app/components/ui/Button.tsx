...
const buttonVariants = cva(
	'active:scale-95 inline-flex justify-center rounded-md text-sm font-medium transition-color focus:outline-none docus:ring-2 focus:ring-slate-400 focus-offset-2 disabled:opacity-50 dark:focus:ring-slate-400 disabled:pointer-events-none dark:focus:ring-offset-slate-900',
	{
		variants: {
			variant: {
				default:
